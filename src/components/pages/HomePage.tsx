...
export const HomePage: React.FC<HomePageProps> = ({
  ...
  const handleFeatureClick = (feature: Feature) => {
    ...
    if (feature.requiresAuth && !isFeatureAvailable(feature.id)) {
    ...
    } else if (feature.requiresAuth && isAuthenticated && isFeatureAvailable(feature.id)) {
        console.log('User has an active plan with credits. Navigating to page.');
        onPageChange(feature.id);
    } else if (!feature.requiresAuth) {
        // This is for the free feature (JD-Based Optimizer)
        console.log('Feature does not require auth. Navigating to page.');
        onPageChange(feature.id);
    }
  };
