        ...
        <div className="container-responsive py-8">
          ...
          <div className="text-center mb-8">
            <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-200">
              ...
              className="mb-6 mt-8 bg-primary-600 text-white hover:bg-primary-700 active:bg-primary-800 shadow-md hover:shadow-lg py-3 px-5 rounded-xl inline-flex items-center space-x-2 transition-all duration-200"
            >
